...
/**
 * Get balance sheets for a company. Returns assets, liabilities, and shareholders equity data.
 *
...
export async function getBalanceSheets(params: Input): Promise<CallToolResult> {
  return await callFunction("poke", "get_balance_sheets", params);
}
