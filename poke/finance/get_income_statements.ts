...
/**
 * Get income statements for a company. Returns revenue, expenses, profits, and other income statement data.
 *
...
export async function getIncomeStatements(params: Input): Promise<CallToolResult> {
  return await callFunction("poke", "get_income_statements", params);
}
